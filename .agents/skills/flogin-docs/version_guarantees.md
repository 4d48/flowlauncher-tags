...
- [Version Guarantees](#){.current .reference .internal}
:::
::::
::::::
:::::::
...
[View this
page]{.visually-hidden}](_sources/version_guarantees.rst.txt "View this page"){.muted-link}
:::
...
:::::: {#version-guarantees .section}
[]{#id1}

# Version Guarantees[¶](#version-guarantees "Link to this heading"){.headerlink}

The library follows [semantic versioning
principles](https://semver.org/){.reference .external}. The major
version is incremented for incompatible API changes. While we strive to
clearly identify breaking changes, the determination can sometimes be
complex due to the interconnected nature of API components.

The first thing to keep in mind is that breaking changes only apply to
things that are **publicly documented**. If it's not listed in the
...
::: {#examples-of-breaking-changes .section}
## Examples of Breaking Changes[¶](#examples-of-breaking-changes "Link to this heading"){.headerlink}
...
::: {#examples-of-non-breaking-changes .section}
## Examples of Non-Breaking Changes[¶](#examples-of-non-breaking-changes "Link to this heading"){.headerlink}

- Adding or removing private underscored attributes.

- Adding an element into the [`__slots__`{.docutils .literal
  .notranslate}]{.pre} of a data class.

- Changing the behaviour of a function to fix a bug.

- Changes in the typing behaviour of the library

- Changes in the calling convention of functions that are primarily
  meant as callbacks
...
:::::: related-pages
[![](data:image/svg+xml;base64,PHN2ZyBjbGFzcz0iZnVyby1yZWxhdGVkLWljb24iPjx1c2UgaHJlZj0iI3N2Zy1hcnJvdy1yaWdodCIgLz48L3N2Zz4=){.furo-related-icon}](whats_new.html){.prev-page}
...
:::: toc-tree-container
::: toc-tree
- [Version Guarantees](#){.reference .internal}
  - [Examples of Breaking
    Changes](#examples-of-breaking-changes){.reference .internal}
  - [Examples of Non-Breaking
    Changes](#examples-of-non-breaking-changes){.reference .internal}
:::
::::
::::::
:::::::
