...
- [Log Override Files](#){.current .reference .internal}
...
[View this
page]{.visually-hidden}](_sources/log-override-files.rst.txt "View this page"){.muted-link}
:::
...
::::::: {#log-override-files .section}
# Log Override Files[¶](#log-override-files "Link to this heading"){.headerlink}

Flogin provides the ability to forcibly disable/enable logs for your
plugin based on if certain files are present in the plugin's directory.
This check is done in your [[`Plugin`{.xref .py .py-class .docutils
.literal
.notranslate}]{.pre}](api.html#flogin.plugin.Plugin "flogin.plugin.Plugin"){.reference
.internal} constructor and in its [[`run()`{.xref .py .py-meth .docutils
.literal
.notranslate}]{.pre}](api.html#flogin.plugin.Plugin.run "flogin.plugin.Plugin.run"){.reference
.internal} method.

::: {.admonition .note}
Note

The [`disable_log_override_files`{.docutils .literal
.notranslate}]{.pre} option can be passed to [[`Plugin`{.xref .py
.py-class .docutils .literal
.notranslate}]{.pre}](api.html#flogin.plugin.Plugin "flogin.plugin.Plugin"){.reference
.internal} to disable this behavior.
:::

::: {#flogin-debug .section}
## .flogin.debug[¶](#flogin-debug "Link to this heading"){.headerlink}

If the [`.flogin.debug`{.docutils .literal .notranslate}]{.pre} file is
present, then logs will forcibly be enabled using
[[`utils.setup_logging()`{.xref .py .py-func .docutils .literal
.notranslate}]{.pre}](api.html#flogin.utils.setup_logging "flogin.utils.setup_logging"){.reference
.internal}.
:::

::: {#flogin-prod .section}
## .flogin.prod[¶](#flogin-prod "Link to this heading"){.headerlink}

If the [`.flogin.prod`{.docutils .literal .notranslate}]{.pre} file is
present, then logs will forcibly be disabled, but only if they were
setup using [[`utils.setup_logging()`{.xref .py .py-func .docutils
.literal
.notranslate}]{.pre}](api.html#flogin.utils.setup_logging "flogin.utils.setup_logging"){.reference
.internal}.
:::
...
::: {#matching .section}
## Matching[¶](#matching "Link to this heading"){.headerlink}

Flogin uses a star pattern at the start of the filename when looking for
the files, so you can add whatever prefix you want. For example:
[`REMOVE-TO-ENABLE-LOGS.flogin.prod`{.docutils .literal
.notranslate}]{.pre}.
:::
:::::::
:::::::::::
...
[![](data:image/svg+xml;base64,PHN2ZyBjbGFzcz0iZnVyby1yZWxhdGVkLWljb24iPjx1c2UgaHJlZj0iI3N2Zy1hcnJvdy1yaWdodCIgLz48L3N2Zz4=){.furo-related-icon}](complex_plugins.html){.prev-page}
...
:::: toc-tree-container
::: toc-tree
- [Log Override Files](#){.reference .internal}
  - [.flogin.debug](#flogin-debug){.reference .internal}
  - [.flogin.prod](#flogin-prod){.reference .internal}
  - [Matching](#matching){.reference .internal}
:::
::::
::::::
:::::::
