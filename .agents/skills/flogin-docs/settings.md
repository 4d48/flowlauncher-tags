...
- [Plugin Settings](#){.current .reference .internal}
...
[View this
page]{.visually-hidden}](_sources/settings.rst.txt "View this page"){.muted-link}
:::
...
# Plugin Settings[¶](#plugin-settings "Link to this heading"){.headerlink}

For your plugin to have settings, you need to make a
[`SettingsTemplate.yaml`{.docutils .literal .notranslate}]{.pre} file.

::: {#settingstemplate-yaml .section}
## SettingsTemplate.yaml[¶](#settingstemplate-yaml "Link to this heading"){.headerlink}

The [`SettingsTemplate.yaml`{.docutils .literal .notranslate}]{.pre}
file is how to tell flow what settings to display in the settings menu.

- [Flow Launcher Guide on
  SettingsTemplate.yaml](https://www.flowlauncher.com/docs/#/json-rpc-settings?id=settingstemplateyaml){.reference
  .external}

- [JSON
  Schema](https://www.flowlauncher.com/schemas/settings-template.schema.json){.reference
  .external}
:::

:::::::::: {#settings-api .section}
## Settings API[¶](#settings-api "Link to this heading"){.headerlink}

To access the settings from your plugin, you can use the
[[`flogin.plugin.Plugin.settings`{.xref .py .py-attr .docutils .literal
.notranslate}]{.pre}](api.html#flogin.plugin.Plugin.settings "flogin.plugin.Plugin.settings"){.reference
.internal} attribute to get a [[`Settings`{.xref .py .py-class .docutils
.literal
.notranslate}]{.pre}](api.html#flogin.settings.Settings "flogin.settings.Settings"){.reference
.internal} instance, which you will use to access your plugin's
settings.

::::::::: {#typing .section}
### Typing[¶](#typing "Link to this heading"){.headerlink}

To add proper typing to your settings instance, create a subclass of
[[`Settings`{.xref .py .py-class .docutils .literal
.notranslate}]{.pre}](api.html#flogin.settings.Settings "flogin.settings.Settings"){.reference
.internal} and add your settings. Example:
...
To register your subclass, pass it as a generic argument to your plugin.
For example:
...
::::::::: related-pages
[](complex_plugins.html){.next-page}
...
[![](data:image/svg+xml;base64,PHN2ZyBjbGFzcz0iZnVyby1yZWxhdGVkLWljb24iPjx1c2UgaHJlZj0iI3N2Zy1hcnJvdy1yaWdodCIgLz48L3N2Zz4=){.furo-related-icon}](install_plugin.html){.prev-page}
...
:::: toc-tree-container
::: toc-tree
- [Plugin Settings](#){.reference .internal}
  - [SettingsTemplate.yaml](#settingstemplate-yaml){.reference
    .internal}
  - [Settings API](#settings-api){.reference .internal}
    - [Typing](#typing){.reference .internal}
:::
::::
::::::
:::::::
